...
public class UnmarshallingTest {
    ...
    public void unmarshallXmlTest() throws JAXBException {
        ...
        assertThat(device.getSerial(), is("E12345678"));

        Positions positions = device.getPositions();
        Position position = positions.getPosition().get(0);
        assertThat(position.getLatitude(), is(57.7152863));
        assertThat(position.getLongitude(), is(11.9736080));
        assertThat(position.getGps().toString(), is("2020-09-02T14:59:01"));
        assertThat(position.getCourse(), is(123.0));
        assertThat(position.getSpeed().getKnots(), is(1.2));
    }
